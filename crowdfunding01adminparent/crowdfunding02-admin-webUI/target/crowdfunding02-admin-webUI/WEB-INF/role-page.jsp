...
<script type="text/javascript">
    $(function () {
        ...
        $("#saveRoleBtn").click(function () {
            ...
            // #addModal表示整个模态框
            // “ ”空格表示在之后继续查找
            // [name=roleName]表示name属性等于rolename的元素
        ...
        /**
         * 更新模态框
         * 用jquery对象的on()解决多个页面btn绑定问题，找到共用静态元素#rolePageBody
         * on(事件类型， 绑定事件的选择器， 事件的响应函数)
         */
        $("#rolePageBody").on("click", ".pencilBtn", function () {
            ...
            // 获取当前角色的 id， 依据是：var pencilBtn = "<button id='"+roleId+"' ……这段代码中我们把 roleId 设置到id 属性了
