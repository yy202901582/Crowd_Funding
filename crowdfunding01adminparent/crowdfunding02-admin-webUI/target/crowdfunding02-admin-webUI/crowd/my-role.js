...
function fillTableBody(pageInfo) {
    ...
    if (pageInfo == null || pageInfo == undefined || pageInfo.list.length == 0) {
        $("#rolePageBody").append("<tr style='text-align: center'><td colspan='4'>data not found</p></td></tr>");
        return;
    }
...
function generateNavigator(pageInfo) {
    ...
    var properties = {
        ...
        callback: paginationCallBack,                         // 指定用户点击页数跳转页面使用的回调函数
        items_per_page: pageInfo.pageSize,                    // 每页显示数据的数量
        current_page: pageInfo.pageNum - 1,                   // 当前页数pageIndex从0开始,pageNum从1开始
    }
// 调用 pagination()函数
