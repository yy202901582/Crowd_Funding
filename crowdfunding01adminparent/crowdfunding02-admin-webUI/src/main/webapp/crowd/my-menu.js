...
/**
 * 修改默认的图标
 * @param treeId 是树形结构附着<ul id="treeDemo" class="ztree"></ul>标签的id
 * @param treeNode 当前树形结构的全部节点及其数据
 */
function myAddDiyDom(treeId, treeNode) {
    /**
     * zTree生成id的规则：treeDome_1_ico (ul标签的id_当前节点的序号_ico)
     * 根据id的生成规则拼接出来span标签的id
     */
    var spanId = treeNode.tId + "_ico";

    // 根据控制图标的span标签的id找到这个span标签， 删除旧的span标签
