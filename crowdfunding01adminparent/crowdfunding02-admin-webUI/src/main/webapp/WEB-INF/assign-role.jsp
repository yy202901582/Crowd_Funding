...
<script type="text/javascript">
    $(function () {
        $("#toRightBtn").click(function(){
            /**
             *  select 是标签选择器 :eq(0)表示选择页面上的第一个 :eq(1)表示选择页面上的第二个 “>”表示选择子元素
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="assign/do/role/assign.html" type="post" role="form" class="form-inline">
                        ...
                        <button type="submit" style="width: 100px;height: 50px" class="btn btn-lg btn-success btn-block">保存</button>
                    </form>
                </div>
            </div>
        </div>
